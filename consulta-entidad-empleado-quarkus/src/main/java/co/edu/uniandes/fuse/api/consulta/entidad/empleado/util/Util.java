package co.edu.uniandes.fuse.api.consulta.entidad.empleado.util;
...
public class Util
{
  ...
  {
    try {
      return FECHA.parse(date); } catch (Exception e) {
    }
    return null;
  }
  ...
  public static Date getDate(Object date)
  {
    try
    {
      return FECHA.parse(FECHA.format(date)); } catch (Exception e) {
    }
    return null;
  }
